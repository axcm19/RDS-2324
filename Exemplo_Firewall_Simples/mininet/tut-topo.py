...
class SingleSwitchTopo(Topo):
    def __init__(self, sw_path, json_path, thrift_port, n, **opts):
        ...
        self.addLink(host1, router1, addr2=sw_mac1)

        host2 = self.addHost('h2',
                            ip = host_ip_base % (2),
                            mac = host_mac_base % (2))
        sw_mac2 = sw_mac_base % (2)
        self.addLink(host2, router2,  addr2=sw_mac2)

        host3 = self.addHost('h3',
                            ip = host_ip_base % (3),
                            mac = host_mac_base % (3))
        sw_mac3 = sw_mac_base % (3)
        self.addLink(host3, router3,  addr2=sw_mac3)
        ...
        self.addLink(router1, router2, addr1=sw_mac4, addr2=sw_mac5)
        self.addLink(router1, router3, addr1=sw_mac6, addr2=sw_mac7)
        self.addLink(router2, router3, addr1=sw_mac8, addr2=sw_mac9)
